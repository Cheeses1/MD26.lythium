...
if (hasInterface) then {
    ...
    [] call compile preprocessFileLineNumbers "modules\kp_cratefiller\KPCF_config.sqf";

    // Read the variables
    [] call compile preprocessFileLineNumbers "modules\kp_cratefiller\KPCF\variables.sqf";
